...
def run(*argv):
	...
	parser.add_argument('--name', type=str, default=None,
		help='The name of your model, used for tensorboard and checkpoints. Default: runXXXXXX_XXXXXX (initialized by current time)')
	...
	parser.add_argument('--roberta', type=str, default="roberta-base", help="the name of pretrained model")
	parser.add_argument('--droprate', type=int, default=0.5, help="dropout rate")
	parser.add_argument('--pos_weight', type=float, default=1, help="the weight of the postive samples")
	parser.add_argument('--threshold', type=float, default=0.5, help="the threshold for classification")
	...
	parser.add_argument('--batch_per_epoch', type=int, default=1000, help="Updates per epoch. Default: 1000")
	...
	parser.add_argument('--dryrun', action='store_true', help="Only show the arguments")
	...
	args.premodel = "classifier"
	args.roberta = cargs.roberta
	args.droprate = cargs.droprate
	args.pos_weight = cargs.pos_weight
	args.threshold = cargs.threshold
